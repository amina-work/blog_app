...
?>
    ...
    <section class="form-section">
        <div class="container form-section__container">
            ...
            <?php endif ?> 
            <form class="form" action="<?= ROOT_URL ?>admin/add-post-logic.php" enctype="multipart/form-data" method="POST">
                ...
                <?php if(isset($_SESSION['user_is_admin'])) : ?>
                    <div class="form__control inline">
                        <input type="checkbox" name="is_featured" value="<?= $is_featured ?>" value="1" id="is_featured" checked>
